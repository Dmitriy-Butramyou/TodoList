...
public class MainController {
    ...
    public String index(@AuthenticationPrincipal User currentUser,
        ...
        Iterable<Task> tasks = taskRepo.findAllByCompleteFalseAndDeletedFalseAndAuthorTask(currentUser);
        ...
        if (day != null && !day.isEmpty()) {
            switch (day) {
                case "Today":
                    tasks = taskRepo.findAllByDeadlineAndCompleteFalseAndDeletedFalseAndAuthorTask(nowTime, currentUser);
                ...
                case "Deadline Missing":
                    tasks = taskRepo.findAllByDeadlineBeforeAndCompleteFalseAndDeletedFalseAndAuthorTask(nowTime, currentUser);
        ...
        if(!deadline.isEmpty()) {
            ...
            tasks = taskRepo.findAllByDeadlineAndAuthorTask(deadlineTime, currentUser);
